/**
    ...
    * @returns object
    */
const stringToProps = (propsStr: string, objectEnum?: { [name: string]: any }, agreementChar?: string) => {
    try {
        ...
        for (let i in _props) {
            ...
            if (theValue) {
                ...
                if ((typeof theValue === "string") && ((theValue.indexOf(theAgreementChar)) !== -1) && objectEnum) {
