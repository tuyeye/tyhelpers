...
function JsonProTableCreate<T extends Record<string, any>, ValueType>(
  props: JsonProTableCreateProps<T, ValueType>,
) {
  const [loading, setLoading] = useState<boolean>(false);

  const [createProps, setCreateProps] = useState<ProFormProps>({});
  const [createColumns, setCreatColumns] = useState<
